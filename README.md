...
- Some source–destination city pairs do not contain flight records.
...
To verify that the route filtering and prediction system is working correctly:

- Select **Chennai** as the source city.
- Select **Kolkata** as the destination city.
- The system should successfully return the available flight information for this route.
